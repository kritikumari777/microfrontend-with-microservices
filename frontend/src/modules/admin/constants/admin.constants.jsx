import { FaBox, FaCartPlus, FaCog, FaHome, FaShoppingCart, FaSignOutAlt, FaTable, FaTruck, FaUber, FaUsers } from "react-icons/fa"
const menuItems = [
    ...
    { name: "Supplier", path: "/admin-dashboard/supplier", icon: <FaTruck />, isParent: true},
    { name: "Cart", path: "/admin-dashboard/cart", icon:<FaCartPlus />, isParent: true },
